...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Delivery Method</h1>
                <p class="mt-1 text-sm text-gray-600">Update shipping method details</p>
            </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.delivery.methods.update', $method) }}" method="POST">
        @csrf
        @method('PUT')
