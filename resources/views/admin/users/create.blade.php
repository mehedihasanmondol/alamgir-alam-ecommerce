        ...
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl">
            ...
            <div class="p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2 group">
                            ...
                            <textarea name="address" 
                                      ...
                                      class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div id="author-info-section" 
                     class="space-y-6 {{ old('role') == 'author' ? '' : 'hidden' }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 group">
                            ...
                            <textarea name="author_bio" 
                                      ...
                                      class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200">{{ old('author_bio') }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2 bg-gradient-to-r from-orange-50 to-yellow-50 p-4 rounded-xl border-2 border-orange-100">
                            <label class="flex items-center space-x-3 cursor-pointer group">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('author_is_featured') ? 'checked' : '' }}
                        ...
                        <div class="group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('author_display_order', 0) }}"
                                   min="0"
                                   placeholder="0"
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200">
            ...
            <!-- Form Actions -->
            <div class="px-8 py-6 bg-gradient-to-r from-gray-50 to-gray-100 border-t-2 border-gray-200 flex justify-end items-center gap-3">
