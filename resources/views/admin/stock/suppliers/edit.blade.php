            ...
            <form method="POST" action="{{ route('admin.suppliers.update', $supplier->id) }}">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="tel" name="mobile" value="{{ old('mobile', $supplier->mobile) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                            @error('mobile')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                ...
                <div class="mb-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Phone</label>
                            <input type="tel" name="contact_person_phone" value="{{ old('contact_person_phone', $supplier->contact_person_phone) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                            <input type="email" name="contact_person_email" value="{{ old('contact_person_email', $supplier->contact_person_email) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                ...
                <div class="mb-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="payment_terms" value="{{ old('payment_terms', $supplier->payment_terms) }}" min="0"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                            @error('payment_terms')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
