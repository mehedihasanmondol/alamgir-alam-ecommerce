...
<div class="container-fluid px-4 py-6">
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">Manage your product suppliers and vendors</p>
        </div>
                    ...
                    @forelse($suppliers as $supplier)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-sm text-gray-500">{{ $supplier->phone ?? $supplier->email ?? 'No contact' }}</div>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-900">
                                {{ $supplier->city ?? $supplier->country }}
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900">{{ $supplier->payment_terms }} days</div>
                                <div class="text-sm text-gray-500">৳{{ number_format($supplier->credit_limit, 2) }} limit</div>
                            </td>
                            <td class="px-6 py-4">
