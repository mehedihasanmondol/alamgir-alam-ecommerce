<div x-data="{ mediaId: @entangle('media_id') }">
    ...
    @else
        ...
        <div class="flex gap-3 mt-2">
            <button type="button"
                    onclick="Livewire.dispatch('openMediaLibrary', { field: 'post_featured_image', multiple: false })"
            ...
            <button type="button"
                    onclick="Livewire.dispatch('openUploader', { field: 'post_featured_image', multiple: false })"
