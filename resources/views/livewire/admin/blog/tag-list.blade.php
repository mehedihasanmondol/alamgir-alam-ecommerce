<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Organize your blog posts with tags</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Used in Posts</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $statistics['used'] }}</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" 
                            wire:click="sortByColumn('posts_count')">
                            <div class="flex items-center gap-1">
                                Posts
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <div>
                                ...
                                @if($tag->description)
                                    <div class="text-sm text-gray-500 mt-1">{{ Str::limit($tag->description, 60) }}</div>
                                @endif
                            </div>
                        </td>
                            ...
                            <div class="flex items-center gap-2">
                                <button wire:click="toggleStatus({{ $tag->id }})" 
                                    ...
                                    <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform
                                        {{ $tag->is_active ? 'translate-x-6' : 'translate-x-1' }}"></span>
                                </button>
                            </div>
                        </td>
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showDeleteModal') }">
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-200"
                ...
                <h3 class="text-lg font-medium text-gray-900 text-center mb-2">Delete Tag</h3>
                <p class="text-sm text-gray-500 text-center mb-6">Are you sure you want to delete this tag? This action cannot be undone.</p>
