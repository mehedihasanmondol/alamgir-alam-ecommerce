<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600">Spam</p>
    ...
    @include('livewire.admin.blog.partials.comment-filters')
    @include('livewire.admin.blog.partials.comment-table-content')
    @include('livewire.admin.blog.partials.comment-view-modal')
    @include('livewire.admin.blog.partials.comment-delete-modal')
</div>
