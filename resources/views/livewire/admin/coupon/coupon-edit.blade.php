                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Current usage: {{ $coupon->total_used }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-semibold text-gray-900">{{ $coupon->total_used }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-600">Unique Users:</span>
                            <span class="font-semibold text-gray-900">{{ $coupon->users()->distinct('user_id')->count() }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-600">Created:</span>
                            <span class="font-semibold text-gray-900">{{ $coupon->created_at->format('M d, Y') }}</span>
                        </div>
                    </div>
                </div>
