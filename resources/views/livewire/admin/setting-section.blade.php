    ...
    <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                'feedback_sites' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"></path>',
            ...
            <div class="setting-item bg-white p-5 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                ...
                <div wire:ignore>
                    <textarea
                        ...
                        data-setting-key="{{ $setting->key }}">{{ $settings[$setting->key] ?? '' }}</textarea>
                </div>
