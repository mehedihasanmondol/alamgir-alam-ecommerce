<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Manage product brands with SEO configuration</p>
        </div>
                            ...
                            <div class="flex items-center gap-2">
                                <button wire:click="toggleStatus({{ $brand->id }})" 
                                    ...
                                    <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform
                                        {{ $brand->is_active ? 'translate-x-6' : 'translate-x-1' }}"></span>
                                </button>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <button wire:click="toggleFeatured({{ $brand->id }})" 
                                ...
                                @else
                                    <span class="text-gray-300" title="Not Featured">
                                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                        </svg>
                                    </span>
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ show: @entangle('showDeleteModal') }">
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative rounded-lg shadow-xl max-w-md w-full p-6 border border-gray-200"
                ...
                <h3 class="text-lg font-medium text-gray-900 text-center mb-2">Delete Brand</h3>
                <p class="text-sm text-gray-500 text-center mb-6">Are you sure you want to delete this brand? This action cannot be undone.</p>
