...
<div class="fixed inset-0 z-50 overflow-y-auto" 
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="relative rounded-lg shadow-2xl max-w-md w-full p-6 border border-gray-200"
            ...
            <!-- Title -->
            <h3 class="text-lg font-bold text-gray-900 text-center mb-2">Delete Review</h3>
            
            <!-- Message -->
            <p class="text-sm text-gray-600 text-center mb-6">Are you sure you want to delete this review? This action cannot be undone.</p>
