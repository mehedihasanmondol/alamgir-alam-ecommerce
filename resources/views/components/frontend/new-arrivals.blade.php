...
<section class="py-8 bg-white border-t border-b border-gray-200">
    <div class="container mx-auto px-4">
        ...
        <div class="relative">
            <!-- Navigation Buttons -->
            <button 
                onclick="scrollCarousel('newarrival-slider', 'left')" 
            ...
            <button 
                onclick="scrollCarousel('newarrival-slider', 'right')" 
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const slider = document.getElementById('newarrival-slider');
        const prevBtn = document.getElementById('newarrival-prev');
        const nextBtn = document.getElementById('newarrival-next');
