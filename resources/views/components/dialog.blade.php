...
<div x-data="{ show: @js($show) }"
    ...
    <div class="flex items-center justify-center min-h-screen p-4 sm:p-6">
        <div x-show="show"
             ...
             @click.stop
             class="relative w-full {{ $maxWidthClass }} bg-white rounded-lg shadow-2xl border border-gray-200 overflow-hidden"
            ...
            <!-- Content (Scrollable) -->
            <div class="px-6 py-4 overflow-y-auto flex-1" style="max-height: calc(100vh - 280px);">
                {{ $slot }}
            </div>
        </div>
    </div>
