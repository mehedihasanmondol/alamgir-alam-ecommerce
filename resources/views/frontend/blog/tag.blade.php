                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                        ...
                        <form action="{{ route('blog.tag', $tag->slug) }}" method="GET" class="flex-1 w-full lg:max-w-md">
                            <div class="relative flex gap-2">
                                ...
                                <button type="submit" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2.5 rounded-lg font-medium transition-colors whitespace-nowrap">
                                    Search
                                </button>
                            </div>
                        </form>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-sm text-gray-500">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <div class="w-6 h-6 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full flex items-center justify-center text-white text-xs font-bold">
                                    ...
                                    <div class="pt-2">
                                        <a href="{{ route('products.show', $post->slug) }}" 
                                           class="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg font-medium text-sm transition-colors">
                                            <span>Read More</span>
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
